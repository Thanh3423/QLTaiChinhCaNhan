...
{
    public partial class Thưởng : Form
    {
        ...
        public void BindingData()
        {
            ...
            string query = "SELECT * FROM QLThu WHERE TenLoaiThu = 'thuong'";
        ...
        private void btnTim_Click(object sender, EventArgs e)
        {
                ...
                if (kiemTraTimKiem() == true)
                {
                    ...
                    string query = @"SELECT * FROM QLThu WHERE TenLoaiThu = 'thuong' AND GhiChu LIKE N'%" + txtTimGhiChu.Text.Trim() + "%'";
                    SqlCommand cmd = new SqlCommand(query, conn);
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
                    DataSet ds = new DataSet();
                    da.Fill(ds);
